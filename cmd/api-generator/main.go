...
func (g *generator) genRouter(routers []Router) {
	...
	g.WriteString("\"github.com/TeaBoss-Developer/go-cqhttp/coolq\"\n")
	g.WriteString("\"github.com/TeaBoss-Developer/go-cqhttp/global\"\n")
	g.WriteString("\"github.com/TeaBoss-Developer/go-cqhttp/pkg/onebot\"\n")
	g.WriteString(")\n\n")
